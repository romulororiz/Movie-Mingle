		...
		<li>
			<NavigationMenuLink asChild>
				<Link
					...
					href={props.href!}
					className={cn(
						'block group select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:text-accent-primary focus:text-accent-primary',
						className
					)}
					{...props}
				>
