...
export default function Home() {
	...
	const { data: popularActors, isLoading: popularActorsLoading } = usePopularActors();
	...
	return (
		<>
			<HeroBgSection isLoading={nowPlayingLoading} trendingMovies={nowPlaying?.results!} />
			...
			>
				{!nowPlayingLoading ? (
					<SwiperComponent movies={nowPlaying?.results!} isLoading={popularMoviesLoading} />
				) : (
			...
			<Section icon="ThumbsUp" className="mt-16 md:mt-40" title="Popular" route="/movies/popular">
