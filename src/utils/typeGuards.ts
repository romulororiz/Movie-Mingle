import { GenreResponse, MovieResponse, PeopleResponse } from '@/types/tmdb';
...
export const isMovieData = (data: any): data is MovieResponse[] => {
	if (
		'page' in data &&
		'total_pages' in data &&
...
export const isPeopleResponse = (data: any): data is MovieResponse[] => {
...
export const isPeopleData = (data: any): data is PeopleResponse[] => {
	if (
		'page' in data &&
		'total_pages' in data &&
		'total_results' in data &&
